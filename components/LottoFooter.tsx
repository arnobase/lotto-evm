...
const LottoFooter: React.FC = () => {
  return (
    <div className="flex items-center justify-center">
      <div className="margin-auto text-center text-lg align-middle leading-8">
        <div></div>
        <div>
          Lotto is a game made by{' '}
          <ExportedImage 
          ...
          <ExportedImage 
            ...
            width={25} 
          />
          <span className={`${unbounded.className} align-middle pl-1`}>
            PI<span className='mirrorX inline-block'>N</span>K
          </span>
          {' '}and{' '}
          <ExportedImage 
            className="inline" 
        ...
        <div>
          ...
          <img 
            ...
            src="https://apillon.io/images/logo.svg" 
            width="120" 
            alt="Apillon"
          />
        </div>
